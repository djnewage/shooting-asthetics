...
export const ContactSection = () => {
  return (
    <section id="contact" className="w-full bg-black py-20 md:py-28 px-6">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-zinc-800 border border-zinc-700 flex items-center justify-center hover:bg-zinc-700 transition-colors">
          ...
          <div className="bg-zinc-900 p-8">
            ...
            <form className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-3 py-2 bg-zinc-800 border border-zinc-700 text-white focus:outline-none focus:border-white"
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-white text-black hover:bg-gray-200 transition-colors flex items-center justify-center gap-2">
